...
?>
    <body>
        ...
        <div class="profile-pic mt-3">
          ...
          <h4 class="text-center mt-2">Pay</h4>

          <div class="mt-5" style="width:50%;margin-left:25%;">
              <h5 class="text-center job-description">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Illum reprehenderit culpa veniam iure cum modi hic eligendi accusantium impedit, dolorem vero quam eveniet ex perspiciatis beatae nihil. Repudiandae, aliquid neque!
          ...
          <div class="mt-5 d-flex justify-content-center">
            ...
            <a href="addJobs.php"><button class="btn btn-primary" type="submit">Done</button></a>
          </div>
<?php
  include 'footer.php';
?>